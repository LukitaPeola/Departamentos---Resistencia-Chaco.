...
# Cargar los datos
ruta_deptos = os.path.join(directorio_actual, 'dataframes', 'alquiler_deptos.csv')
...
ruta_nueva_deptos = os.path.join(directorio_actual, 'dataframes', 'alquiler_deptos_limpio.csv')
